package com.example.sullivanplus.etc;
...
/////구글링 주소 : https://gist.github.com/XiaoxiaoLi/8031146//////
public class ColorUtils {
	...
	private ArrayList<ColorName> initColorList() {
		...
		colorList.add(new ColorName(getStringArray(R.array.array_color_black),0x00, 0x00, 0x00));
		colorList.add(new ColorName(getStringArray(R.array.array_color_white), 0xFF, 0xFF, 0xFF));
		colorList.add(new ColorName(getStringArray(R.array.array_color_darkgray), 0xA9, 0xA9, 0xA9));
		colorList.add(new ColorName(getStringArray(R.array.array_color_gray),0x80, 0x80, 0x80));
		colorList.add(new ColorName(getStringArray(R.array.array_color_plum), 0xDD, 0xA0, 0xDD));
		colorList.add(new ColorName(getStringArray(R.array.array_color_darkred), 0x8B, 0x00, 0x00));
		colorList.add(new ColorName(getStringArray(R.array.array_color_red),0xFF, 0x00, 0x00));
		colorList.add(new ColorName(getStringArray(R.array.array_color_orange),0xFF, 0xA5, 0x00));
		colorList.add(new ColorName(getStringArray(R.array.array_color_yellow),0xFF, 0xFF, 0x00));
		colorList.add(new ColorName(getStringArray(R.array.array_color_yellowgreen), 0x9A, 0xCD, 0x32));
		colorList.add(new ColorName(getStringArray(R.array.array_color_green),0x00, 0x80, 0x00));
		colorList.add(new ColorName(getStringArray(R.array.array_color_darkgreen),0x00, 0x64, 0x00));
		colorList.add(new ColorName(getStringArray(R.array.array_color_turquoise),0x40, 0xE0, 0xD0));
		colorList.add(new ColorName(getStringArray(R.array.array_color_skyblue),0x87, 0xCE, 0xEB));
		colorList.add(new ColorName(getStringArray(R.array.array_color_blue), 0x00, 0x00, 0xFF));
		colorList.add(new ColorName(getStringArray(R.array.array_color_darkblue), 0x00, 0x00, 0x8B));
		colorList.add(new ColorName(getStringArray(R.array.array_color_navy),0x00, 0x00, 0x80));
		colorList.add(new ColorName(getStringArray(R.array.array_color_violet), 0xEE, 0x82, 0xEE));
		colorList.add(new ColorName(getStringArray(R.array.array_color_brown),0xA5, 0x2A, 0x2A));
		colorList.add(new ColorName(getStringArray(R.array.array_color_gold),0xFF, 0xD7, 0x00));
		colorList.add(new ColorName(getStringArray(R.array.array_color_silver),0xC0, 0xC0, 0xC0));

		//colorList.add(new ColorName("GreenYellow","황록색", 0xAD, 0xFF, 0x2F));
		//colorList.add(new ColorName("AliceBlue","획색 띤 연푸른색",0xF0, 0xF8, 0xFF));
		//colorList.add(new ColorName("AntiqueWhite","", 0xFA, 0xEB, 0xD7));
//		colorList.add(new ColorName("Aqua","청록색", 0x00, 0xFF, 0xFF));
//		colorList.add(new ColorName("Aquamarine","연한 청록색", 0x7F, 0xFF, 0xD4));
//		colorList.add(new ColorName("Azure","하늘색", 0xF0, 0xFF, 0xFF));
		//colorList.add(new ColorName("Beige", "베이지색",0xF5, 0xF5, 0xDC));
		//colorList.add(new ColorName("Bisque", "비스크 색", 0xFF, 0xE4, 0xC4));
		//colorList.add(new ColorName("BlanchedAlmond","블란체달몬드 색", 0xFF, 0xEB, 0xCD));
//		colorList.add(new ColorName("BlueViolet", "남보라색", 0x8A, 0x2B, 0xE2));
		//colorList.add(new ColorName("BurlyWood", "",0xDE, 0xB8, 0x87));
		//colorList.add(new ColorName("CadetBlue", "회색을 띤 청색",0x5F, 0x9E, 0xA0));
		//colorList.add(new ColorName("Chartreuse", "", 0x7F, 0xFF, 0x00));
		//colorList.add(new ColorName("Chocolate", "초콜릿색", 0xD2, 0x69, 0x1E));
		//colorList.add(new ColorName("Coral", "산호색",0xFF, 0x7F, 0x50));
		//colorList.add(new ColorName("CornflowerBlue", "", 0x64, 0x95, 0xED));
		//colorList.add(new ColorName("Cornsilk","콘실크색", 0xFF, 0xF8, 0xDC));
...
//		colorList.add(new ColorName("LightBlue", "옅은 파랑색",0xAD, 0xD8, 0xE6));
...
//		colorList.add(new ColorName("RoyalBlue", 0x41, 0x69, 0xE1));
	...
	public String getColorNameFromRgb(int r, int g, int b) {
		...
		if (closestMatch != null) {
			return closestMatch.getName_korea();
		} else {
...
/*	public int colorToHex(Color c) {
	...
	private String[] getStringArray(int stringArr){
		return context.getResources().getStringArray(stringArr);
	}
	...
	public class ColorName {
		...
		public ColorName(String[] arrString, int r, int g, int b) {
			this.r = r;
			this.g = g;
			this.b = b;

			name_english = arrString[0];
			name_korea = arrString[1];
		}
